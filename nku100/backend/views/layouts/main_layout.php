            ...
            <div class="media">
              ...
              <div class="media-body">
                <div class="media-links">
                   <a href="#" class="sidebar-menu-toggle">用户菜单-</a> <a href="<?php echo Url::to(['site/logout']) ?>"
                   <?php if(!Yii::$app->user->isGuest){ ?>
                   data-method="post">登出 </a>
                </div>
            ...
            <ul class="nav sub-nav">
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['site/personalwork1']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 冷东鹏</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/logout']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 冷东鹏</a>
                  <?php } ?>
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['site/personalwork2']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 胡怡静</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/logout']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 胡怡静</a>
                  <?php } ?>
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
			                  <a href="<?php echo Url::to(['site/personalwork3']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 李科</a>
			                    <?php } else{?>
			                    <a href="<?php echo Url::to(['site/logout']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 李科</a>
			                    <?php } ?>
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
			                  <a href="<?php echo Url::to(['site/personalwork4']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 蒿闪</a>
			                    <?php } else{?>
			                    <a href="<?php echo Url::to(['site/logout']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 蒿闪</a>
			                    <?php } ?>
              ...
              <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
			                  <a href="<?php echo Url::to(['site/personalwork5']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 董向京</a>
			                    <?php } else{?>
			                     <a href="<?php echo Url::to(['site/logout']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 董向京</a>
			                    <?php } ?>
